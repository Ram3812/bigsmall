...
public class TC001_WishList_AddToWishList extends WebDriverHelper {
	...
	public void searchAGift() {
		...
		HP.getSearchBar().sendKeys("Marvel");
		HP.getSearchBar().sendKeys(Keys.ENTER);
		scrnShot.getScreenShot("TC005_WLadd_SearchCatalog");
	...
	public void selecttheGift() {
		...
		SRP.getGift("3D Thor Hammer Mug").click();
	...
	public void addGiftToWishlist() {
		...
		scrnShot.getScreenShot("TC005_WLadd_AddedtoWishList");
	...
	public void validateWishList() {
		...
		scrnShot.getScreenShot("TC005_WLadd_WishListPage");
		logger.info("Validated the wish list...");
	}

	@AfterClass
	public void endTest() {
		logger.info("TC005 Add to WishList succesful...");
		driver.close();
		driver.quit();
	}
}
